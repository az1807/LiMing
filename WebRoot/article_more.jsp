<%@ page language="java" import="java.util.*,com.LiMing.entity.article_more" pageEncoding="UTF-8"%>
<%
...
<div>
    ...
    <section class="article-content">
        <ul>
        <% List<article_more> artm = (List<article_more>)request.getAttribute("artm"); %>
        <% for (int i=0;i<artm.size();i++){ %>
                 
                  <li>
                <div class="article-date">
                    <strong><%=artm.get(i).getId() %></strong>
                    <p><%=artm.get(i).getTime() %></p>
                </div>
                <div class="article-info">
                    <a href="article_list_content.html">
                        <h3><%=artm.get(i).getName() %></h3>
                        <p><%=artm.get(i).getNeirong() %></p>
                    </a>
                </div>
            </li>
            <%    } %>
