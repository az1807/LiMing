...
CREATE TABLE `chanpin` (
  `chanpin_id` int(11) NOT NULL AUTO_INCREMENT,
  `chanpin_mingcheng` varchar(45) DEFAULT NULL,
  `chanpin_shoujia` varchar(45) DEFAULT NULL,
  `leibie_id` varchar(45) DEFAULT NULL,
